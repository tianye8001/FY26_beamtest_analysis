...
int fileReducer_beamtest_gem_survey(string inputfile_name,int numberOfFile=1, double event_actual=1, int evgen=1){
	...
	//TFile* outFile = new TFile(Form("%s_reduce_tree_analysis_pzL0.root",the_filename), "RECREATE");
	TFile* outFile = new TFile(Form("%s_reduce_tree_analysis_gemtrE_nopfcut_test_06032026.root",the_filename), "RECREATE");
	...
	float SPD_P;
	float LASPD_P;
	int virtual1_n=0,virtual2_n=0,virtual3_n=0,virtual4_n=0,virtual5_n=0,virtual6_n=0;
	int GEM00_n=0,GEM10_n=0,GEM01_n=0,GEM11_n=0;
	int SC_A_n=0,SC_B_n=0,SC_D_n=0, PreSh_n=0, Sh_n=0;
	//int Cer_n;
	float virtual1_Ekmax,virtual2_Ekmax, virtual3_Ekmax, virtual4_Ekmax, virtual5_Ekmax, virtual6_Ekmax, virtual7_Ekmax, virtual8_Ekmax, virtual9_Ekmax, virtual10_Ekmax, virtual11_Ekmax;
	float virtual1_pxmax,virtual2_pxmax, virtual3_pxmax, virtual4_pxmax, virtual5_pxmax, virtual6_pxmax, virtual7_pxmax, virtual8_pxmax, virtual9_pxmax, virtual10_pxmax, virtual11_pxmax;
	float virtual1_pymax,virtual2_pymax, virtual3_pymax, virtual4_pymax, virtual5_pymax, virtual6_pymax, virtual7_pymax, virtual8_pymax, virtual9_pymax, virtual10_pymax, virtual11_pymax;
	float virtual1_pzmax,virtual2_pzmax, virtual3_pzmax, virtual4_pzmax, virtual5_pzmax, virtual6_pzmax, virtual7_pzmax, virtual8_pzmax, virtual9_pzmax, virtual10_pzmax, virtual11_pzmax;
	float virtual1_pmax,virtual2_pmax, virtual3_pmax, virtual4_pmax, virtual5_pmax, virtual6_pmax, virtual7_pmax, virtual8_pmax, virtual9_pmax, virtual10_pmax, virtual11_pmax;
	float virtual1_thetamax,virtual2_thetamax,virtual3_thetamax,virtual4_thetamax,virtual5_thetamax,virtual6_thetamax,virtual7_thetamax,virtual8_thetamax,virtual9_thetamax,virtual10_thetamax,virtual11_thetamax;
	float virtual1_vzmax,virtual2_vzmax,virtual3_vzmax,virtual4_vzmax,virtual5_vzmax,virtual6_vzmax,virtual7_vzmax,virtual8_vzmax,virtual9_vzmax,virtual10_vzmax,virtual11_vzmax;
	float virtual1_vxmax,virtual2_vxmax,virtual3_vxmax,virtual4_vxmax,virtual5_vxmax,virtual6_vxmax,virtual7_vxmax,virtual8_vxmax,virtual9_vxmax,virtual10_vxmax,virtual11_vxmax;
	float virtual1_vymax,virtual2_vymax,virtual3_vymax,virtual4_vymax,virtual5_vymax,virtual6_vymax,virtual7_vymax,virtual8_vymax,virtual9_vymax,virtual10_vymax,virtual11_vymax;
	float virtual1_mvzmax,virtual2_mvzmax,virtual3_mvzmax,virtual4_mvzmax,virtual5_mvzmax,virtual6_mvzmax,virtual7_mvzmax,virtual8_mvzmax,virtual9_mvzmax,virtual10_mvzmax,virtual11_mvzmax;
	float virtual1_mvxmax,virtual2_mvxmax,virtual3_mvxmax,virtual4_mvxmax,virtual5_mvxmax,virtual6_mvxmax,virtual7_mvxmax,virtual8_mvxmax,virtual9_mvxmax,virtual10_mvxmax,virtual11_mvxmax;
	float virtual1_mvymax,virtual2_mvymax,virtual3_mvymax,virtual4_mvymax,virtual5_mvymax,virtual6_mvymax,virtual7_mvymax,virtual8_mvymax,virtual9_mvymax,virtual10_mvymax,virtual11_mvymax;
	float virtual1_lzmax,virtual2_lzmax,virtual3_lzmax,virtual4_lzmax,virtual5_lzmax,virtual6_lzmax,virtual7_lzmax,virtual8_lzmax,virtual9_lzmax,virtual10_lzmax,virtual11_lzmax;
	float virtual1_lxmax,virtual2_lxmax,virtual3_lxmax,virtual4_lxmax,virtual5_lxmax,virtual6_lxmax,virtual7_lxmax,virtual8_lxmax,virtual9_lxmax,virtual10_lxmax,virtual11_lxmax;
	float virtual1_lymax,virtual2_lymax,virtual3_lymax,virtual4_lymax,virtual5_lymax,virtual6_lymax,virtual7_lymax,virtual8_lymax,virtual9_lymax,virtual10_lymax,virtual11_lymax;
	float virtual1_azmax,virtual2_azmax,virtual3_azmax,virtual4_azmax,virtual5_azmax,virtual6_azmax,virtual7_azmax,virtual8_azmax,virtual9_azmax,virtual10_azmax,virtual11_azmax;
	float virtual1_axmax,virtual2_axmax,virtual3_axmax,virtual4_axmax,virtual5_axmax,virtual6_axmax,virtual7_axmax,virtual8_axmax,virtual9_axmax,virtual10_axmax,virtual11_axmax;
	float virtual1_aymax,virtual2_aymax,virtual3_aymax,virtual4_aymax,virtual5_aymax,virtual6_aymax,virtual7_aymax,virtual8_aymax,virtual9_aymax,virtual10_aymax,virtual11_aymax;
	...
	float GEM00_lzmax_gem,GEM00_lxmax_gem,GEM00_lymax_gem;
	...
	float GEM00_pzmax,GEM00_pxmax,GEM00_pymax,GEM01_pzmax;
	float GEM00_mvxmax, GEM00_mvymax, GEM00_mvzmax;
	...
	int virtual1_pidmax,virtual2_pidmax,virtual3_pidmax, virtual4_pidmax, virtual5_pidmax, virtual6_pidmax, virtual7_pidmax, virtual8_pidmax, virtual9_pidmax, virtual10_pidmax, virtual11_pidmax;
	int virtual1_procidmax,virtual2_procidmax,virtual3_procidmax, virtual4_procidmax, virtual5_procidmax, virtual6_procidmax, virtual7_procidmax, virtual8_procidmax, virtual9_procidmax, virtual10_procidmax, virtual11_procidmax;
	int virtual1_tidmax,virtual2_tidmax,virtual3_tidmax, virtual4_tidmax, virtual5_tidmax, virtual6_tidmax, virtual7_tidmax, virtual8_tidmax, virtual9_tidmax, virtual10_tidmax, virtual11_tidmax;
	int virtual1_mtidmax,virtual2_mtidmax,virtual3_mtidmax, virtual4_mtidmax, virtual5_mtidmax, virtual6_mtidmax, virtual7_mtidmax, virtual8_mtidmax, virtual9_mtidmax, virtual10_mtidmax, virtual11_mtidmax;
	int virtual1_mpidmax,virtual3_mpidmax,virtual7_mpidmax,virtual8_mpidmax,virtual9_mpidmax,virtual10_mpidmax,virtual11_mpidmax;
        int GEM00_mpidmax;
	...
	outTree->Branch("virtual5_Ekmax",      &virtual5_Ekmax,   "virtual5_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_pmax",      &virtual5_pmax,   "virtual5_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_pxmax",      &virtual5_pxmax,   "virtual5_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_pymax",      &virtual5_pymax,   "virtual5_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_pzmax",      &virtual5_pzmax,   "virtual5_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_thetamax",      &virtual5_thetamax,   "virtual5_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_vzmax",      &virtual5_vzmax,   "virtual5_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_vymax",      &virtual5_vymax,   "virtual5_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_vxmax",      &virtual5_vxmax,   "virtual5_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_mvzmax",      &virtual5_mvzmax,   "virtual5_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_mvymax",      &virtual5_mvymax,   "virtual5_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_mvxmax",      &virtual5_mvxmax,   "virtual5_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_lzmax",      &virtual5_lzmax,   "virtual5_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_lymax",      &virtual5_lymax,   "virtual5_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_lxmax",      &virtual5_lxmax,   "virtual5_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_azmax",      &virtual5_azmax,   "virtual5_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_aymax",      &virtual5_aymax,   "virtual5_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual5_axmax",      &virtual5_axmax,   "virtual5_axmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_Ekmax",      &virtual6_Ekmax,   "virtual6_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_pmax",      &virtual6_pmax,   "virtual6_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_pxmax",      &virtual6_pxmax,   "virtual6_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_pymax",      &virtual6_pymax,   "virtual6_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_pzmax",      &virtual6_pzmax,   "virtual6_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_thetamax",      &virtual6_thetamax,   "virtual6_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_vzmax",      &virtual6_vzmax,   "virtual6_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_vymax",      &virtual6_vymax,   "virtual6_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_vxmax",      &virtual6_vxmax,   "virtual6_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_mvzmax",      &virtual6_mvzmax,   "virtual6_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_mvymax",      &virtual6_mvymax,   "virtual6_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_mvxmax",      &virtual6_mvxmax,   "virtual6_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_lzmax",      &virtual6_lzmax,   "virtual6_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_lymax",      &virtual6_lymax,   "virtual6_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_lxmax",      &virtual6_lxmax,   "virtual6_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_azmax",      &virtual6_azmax,   "virtual6_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_aymax",      &virtual6_aymax,   "virtual6_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual6_axmax",      &virtual6_axmax,   "virtual6_axmax/F"    ); //Sum of the deposit energy in three shower modules

	outTree->Branch("virtual7_Ekmax",      &virtual7_Ekmax,   "virtual7_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_pmax",      &virtual7_pmax,   "virtual7_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_pxmax",      &virtual7_pxmax,   "virtual7_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_pymax",      &virtual7_pymax,   "virtual7_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_pzmax",      &virtual7_pzmax,   "virtual7_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_thetamax",      &virtual7_thetamax,   "virtual7_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_vzmax",      &virtual7_vzmax,   "virtual7_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_vymax",      &virtual7_vymax,   "virtual7_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_vxmax",      &virtual7_vxmax,   "virtual7_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_mvzmax",      &virtual7_mvzmax,   "virtual7_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_mvymax",      &virtual7_mvymax,   "virtual7_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_mvxmax",      &virtual7_mvxmax,   "virtual7_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_lzmax",      &virtual7_lzmax,   "virtual7_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_lymax",      &virtual7_lymax,   "virtual7_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_lxmax",      &virtual7_lxmax,   "virtual7_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_azmax",      &virtual7_azmax,   "virtual7_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_aymax",      &virtual7_aymax,   "virtual7_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual7_axmax",      &virtual7_axmax,   "virtual7_axmax/F"    ); //Sum of the deposit energy in three shower modules

	outTree->Branch("virtual8_Ekmax",      &virtual8_Ekmax,   "virtual8_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_pmax",      &virtual8_pmax,   "virtual8_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_pxmax",      &virtual8_pxmax,   "virtual8_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_pymax",      &virtual8_pymax,   "virtual8_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_pzmax",      &virtual8_pzmax,   "virtual8_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_thetamax",      &virtual8_thetamax,   "virtual8_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_vzmax",      &virtual8_vzmax,   "virtual8_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_vymax",      &virtual8_vymax,   "virtual8_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_vxmax",      &virtual8_vxmax,   "virtual8_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_mvzmax",      &virtual8_mvzmax,   "virtual8_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_mvymax",      &virtual8_mvymax,   "virtual8_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_mvxmax",      &virtual8_mvxmax,   "virtual8_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_lzmax",      &virtual8_lzmax,   "virtual8_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_lymax",      &virtual8_lymax,   "virtual8_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_lxmax",      &virtual8_lxmax,   "virtual8_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_azmax",      &virtual8_azmax,   "virtual8_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_aymax",      &virtual8_aymax,   "virtual8_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual8_axmax",      &virtual8_axmax,   "virtual8_axmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_Ekmax",      &virtual9_Ekmax,   "virtual9_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_pmax",      &virtual9_pmax,   "virtual9_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_pxmax",      &virtual9_pxmax,   "virtual9_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_pymax",      &virtual9_pymax,   "virtual9_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_pzmax",      &virtual9_pzmax,   "virtual9_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_thetamax",      &virtual9_thetamax,   "virtual9_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_vzmax",      &virtual9_vzmax,   "virtual9_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_vymax",      &virtual9_vymax,   "virtual9_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_vxmax",      &virtual9_vxmax,   "virtual9_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_mvzmax",      &virtual9_mvzmax,   "virtual9_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_mvymax",      &virtual9_mvymax,   "virtual9_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_mvxmax",      &virtual9_mvxmax,   "virtual9_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_lzmax",      &virtual9_lzmax,   "virtual9_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_lymax",      &virtual9_lymax,   "virtual9_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_lxmax",      &virtual9_lxmax,   "virtual9_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_azmax",      &virtual9_azmax,   "virtual9_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_aymax",      &virtual9_aymax,   "virtual9_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual9_axmax",      &virtual9_axmax,   "virtual9_axmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_Ekmax",      &virtual10_Ekmax,   "virtual10_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_pmax",      &virtual10_pmax,   "virtual10_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_pxmax",      &virtual10_pxmax,   "virtual10_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_pymax",      &virtual10_pymax,   "virtual10_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_pzmax",      &virtual10_pzmax,   "virtual10_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_thetamax",      &virtual10_thetamax,   "virtual10_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_vzmax",      &virtual10_vzmax,   "virtual10_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_vymax",      &virtual10_vymax,   "virtual10_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_vxmax",      &virtual10_vxmax,   "virtual10_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_mvzmax",      &virtual10_mvzmax,   "virtual10_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_mvymax",      &virtual10_mvymax,   "virtual10_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_mvxmax",      &virtual10_mvxmax,   "virtual10_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_lzmax",      &virtual10_lzmax,   "virtual10_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_lymax",      &virtual10_lymax,   "virtual10_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_lxmax",      &virtual10_lxmax,   "virtual10_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_azmax",      &virtual10_azmax,   "virtual10_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_aymax",      &virtual10_aymax,   "virtual10_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual10_axmax",      &virtual10_axmax,   "virtual10_axmax/F"    ); //Sum of the deposit energy in three shower modules

	outTree->Branch("virtual11_Ekmax",      &virtual11_Ekmax,   "virtual11_Ekmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_pmax",      &virtual11_pmax,   "virtual11_pmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_pxmax",      &virtual11_pxmax,   "virtual11_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_pymax",      &virtual11_pymax,   "virtual11_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_pzmax",      &virtual11_pzmax,   "virtual11_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_thetamax",      &virtual11_thetamax,   "virtual11_thetamax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_vzmax",      &virtual11_vzmax,   "virtual11_vzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_vymax",      &virtual11_vymax,   "virtual11_vymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_vxmax",      &virtual11_vxmax,   "virtual11_vxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_mvzmax",      &virtual11_mvzmax,   "virtual11_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_mvymax",      &virtual11_mvymax,   "virtual11_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_mvxmax",      &virtual11_mvxmax,   "virtual11_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_lzmax",      &virtual11_lzmax,   "virtual11_lzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_lymax",      &virtual11_lymax,   "virtual11_lymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_lxmax",      &virtual11_lxmax,   "virtual11_lxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_azmax",      &virtual11_azmax,   "virtual11_azmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_aymax",      &virtual11_aymax,   "virtual11_aymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("virtual11_axmax",      &virtual11_axmax,   "virtual11_axmax/F"    ); //Sum of the deposit energy in three shower modules
	...
	outTree->Branch("virtual1_mtpidmax", &virtual1_mpidmax,"virtual1_mpidmax/I");// local x of virtual1
	...
	outTree->Branch("virtual3_mpidmax", &virtual3_mpidmax,"virtual3_mpidmax/I");// local x of virtual1
	...
	outTree->Branch("virtual5_pidmax", &virtual5_pidmax,"virtual5_pidmax/I");// local x of virtual1
	outTree->Branch("virtual5_tidmax", &virtual5_tidmax,"virtual5_tidmax/I");// local x of virtual1
	outTree->Branch("virtual5_mtidmax", &virtual5_mtidmax,"virtual5_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual5_procidmax", &virtual5_procidmax,"virtual5_procidmax/I");// local x of virtual1
	outTree->Branch("virtual6_pidmax", &virtual6_pidmax,"virtual6_pidmax/I");// local x of virtual1
	outTree->Branch("virtual6_tidmax", &virtual6_tidmax,"virtual6_tidmax/I");// local x of virtual1
	outTree->Branch("virtual6_mtidmax", &virtual6_mtidmax,"virtual6_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual6_procidmax", &virtual6_procidmax,"virtual6_procidmax/I");// local x of virtual1

	outTree->Branch("virtual7_pidmax", &virtual7_pidmax,"virtual7_pidmax/I");// local x of virtual1
	outTree->Branch("virtual7_tidmax", &virtual7_tidmax,"virtual7_tidmax/I");// local x of virtual1
	outTree->Branch("virtual7_mtidmax", &virtual7_mtidmax,"virtual7_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual7_mpidmax", &virtual7_mpidmax,"virtual7_mpidmax/I");// local x of virtual1
	outTree->Branch("virtual7_procidmax", &virtual7_procidmax,"virtual7_procidmax/I");// local x of virtual1
	outTree->Branch("virtual8_pidmax", &virtual8_pidmax,"virtual8_pidmax/I");// local x of virtual1
	outTree->Branch("virtual8_tidmax", &virtual8_tidmax,"virtual8_tidmax/I");// local x of virtual1
	outTree->Branch("virtual8_mtidmax", &virtual8_mtidmax,"virtual8_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual8_mpidmax", &virtual8_mpidmax,"virtual8_mpidmax/I");// local x of virtual1
	outTree->Branch("virtual8_procidmax", &virtual8_procidmax,"virtual8_procidmax/I");// local x of virtual1
	outTree->Branch("virtual9_pidmax", &virtual9_pidmax,"virtual9_pidmax/I");// local x of virtual1
	outTree->Branch("virtual9_tidmax", &virtual9_tidmax,"virtual9_tidmax/I");// local x of virtual1
	outTree->Branch("virtual9_mtidmax", &virtual9_mtidmax,"virtual9_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual9_mpidmax", &virtual9_mpidmax,"virtual9_mpidmax/I");// local x of virtual1
	outTree->Branch("virtual9_procidmax", &virtual9_procidmax,"virtual9_procidmax/I");// local x of virtual1
	outTree->Branch("virtual10_pidmax", &virtual10_pidmax,"virtual10_pidmax/I");// local x of virtual1
	outTree->Branch("virtual10_tidmax", &virtual10_tidmax,"virtual10_tidmax/I");// local x of virtual1
	outTree->Branch("virtual10_mtidmax", &virtual10_mtidmax,"virtual10_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual10_mpidmax", &virtual10_mpidmax,"virtual10_mpidmax/I");// local x of virtual1
	outTree->Branch("virtual10_procidmax", &virtual10_procidmax,"virtual10_procidmax/I");// local x of virtual1
	outTree->Branch("virtual11_pidmax", &virtual11_pidmax,"virtual11_pidmax/I");// local x of virtual1
	outTree->Branch("virtual11_tidmax", &virtual11_tidmax,"virtual11_tidmax/I");// local x of virtual1
	outTree->Branch("virtual11_mtidmax", &virtual11_mtidmax,"virtual11_mtidmax/I");// local x of virtual1
	outTree->Branch("virtual11_mpidmax", &virtual11_mpidmax,"virtual11_mpidmax/I");// local x of virtual1
	outTree->Branch("virtual11_procidmax", &virtual11_procidmax,"virtual11_procidmax/I");// local x of virtual1
	...
	outTree->Branch("GEM00_lzmax_gem",      &GEM00_lzmax_gem,   "GEM00_lzmax_gem/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_lymax_gem",      &GEM00_lymax_gem,   "GEM00_lymax_gem/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_lxmax_gem",      &GEM00_lxmax_gem,   "GEM00_lxmax_gem/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_vzmax_gem",      &GEM00_vzmax_gem,   "GEM00_vzmax_gem/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_pzmax",      &GEM00_pzmax,   "GEM00_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_mpidmax",      &GEM00_mpidmax,   "GEM00_mpidmax/I"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_pxmax",      &GEM00_pxmax,   "GEM00_pxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_pymax",      &GEM00_pymax,   "GEM00_pymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_mvzmax",      &GEM00_mvzmax,   "GEM00_mvzmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_mvymax",      &GEM00_mvymax,   "GEM00_mvymax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("GEM00_mvxmax",      &GEM00_mvxmax,   "GEM00_mvxmax/F"    ); //Sum of the deposit energy in three shower modules
	outTree->Branch("pid_GEM00", &pid_GEM00,"pid_GEM00/I");// local x of GEM00
	...
	outTree->Branch("pid_GEM10", &pid_GEM10,"pid_GEM10/I");// local x of GEM00
	...
	outTree->Branch("GEM01_pzmax",      &GEM01_pzmax,   "GEM01_pzmax/F"    ); //Sum of the deposit energy in three shower modules
	...
	int N_preshower=0;
	int pid_gen1=0;
	double hit_th_max[23]={0};
	double hit_Ek_max[23]={0};
	double hit_vz_max[23]={0};
	double hit_mvz_max[23]={0};
	double hit_mvx_max[23]={0};
	double hit_mvy_max[23]={0};
	double hit_vx_max[23]={0};
	double hit_vy_max[23]={0};
	double hit_vr_max[23]={0};
	double hit_mvr_max[23]={0};
	double hit_phi_max[23]={0};
	double hit_pid_max[23]={0};
	double hit_azmax[23]={0};
	double hit_axmax[23]={0};
	double hit_aymax[23]={0};
	double hit_vzmax[23]={0};
	double hit_vxmax[23]={0};
	double hit_vymax[23]={0};
	double hit_lzmax[23]={0};
	double hit_lxmax[23]={0};
	double hit_lymax[23]={0};
	double hit_p_max[23]={0};
	double hit_px_max[23]={0};
	double hit_py_max[23]={0};
	double hit_pz_max[23]={0};
	double hit_tid_max[23]={0};
	double hit_mtid_max[23]={0};
	double hit_mpid_max[23]={0};
	int hit_proID_max[23]={0};
	int hit_proID_max_e[23]={0};
	int hit_proID_max_gamma[23]={0};
	double E_max[23]= {0};
	double E_max_gamma[23]= {0};
	double Edep_max_gamma[23]= {0};
	double E_max_ele[23]= {0};
	double Edep_max_ele[23]= {0};
	double Edep_max[23]= {0};
	double hit_th_max_gamma[23]={0};
	double hit_phi_max_gamma[23]={0};
	double hit_vz_max_gamma[23]={0};
	double hit_mvz_max_gamma[23]={0};
	double hit_vx_max_gamma[23]={0};
	double hit_vy_max_gamma[23]={0};
	double hit_vr_max_gamma[23]={0};
	double hit_mvr_max_gamma[23]={0};
	double hit_th_max_e[23]={0};
	double hit_phi_max_e[23]={0};
	double hit_vz_max_e[23]={0};
	double hit_mvz_max_e[23]={0};
	double hit_vx_max_e[23]={0};
	double hit_vy_max_e[23]={0};
	double hit_vr_max_e[23]={0};
	double hit_mvr_max_e[23]={0};
	double hit_pf=0;
	double edep_6p1_max= 0;
	int Is_prime=0;					  
	int Is_ECback=-1;			
		double GEM00_vx_gem=0.;
		double GEM00_vy_gem=0.;
		double GEM00_vz_gem=0.;
		double GEM10_vx_gem=0.;
		double GEM10_vy_gem=0.;
		double GEM10_vz_gem=0.;
		double GEM00_pz_gem=0.;
		double GEM00_px_gem=0.;
		double GEM00_py_gem=0.;
		double GEM01_pz_gem=0.;
		double GEM00_mvx_gem=0.;
		double GEM00_mvy_gem=0.;
		double GEM00_mvz_gem=0.;
	double dE=0;		  
	...
	for(long int i=0;i<nentries;i++){	  		
		...
		for (std::size_t j=0;j<flux_hitn->size();j++) {
			...
			//if(flux_pz->at(j)<0 ){  
				...
				else if(flux_id->at(j)==55) hit_id=16; //
				else if(flux_id->at(j)==56) hit_id=17; //
				else if(flux_id->at(j)==31) hit_id=18; //
				else if(flux_id->at(j)==32) hit_id=19; //
				else if(flux_id->at(j)==33) hit_id=20; //
				else if(flux_id->at(j)==34) hit_id=21; //
				else if(flux_id->at(j)==35) hit_id=22; //
				else cout << "wrong flux_id" << flux_id->at(j) << endl;
				N_preshower ++;
				//if(hit_id==12 || hit_id==14){
			        // cout<<"event="<<i<<"flux="<<j<<"flux_size="<<flux_hitn->size()<<"pf="<<flux_pz->at(j)<<"hit_id="<<hit_id<<endl;
                                // }
			      if(E >= edep_6p1_max){
					edep_6p1_max=E;
					p_max=hit_pf;
				...
				Eend_ec_ps_Esum += E;
			//	cout<<"event="<<i<<" "<<"flux_j="<<j<<" "<<"hit_id="<<hit_id<<" "<<"E="<<E<<" "<<"E_max="<<E_max[hit_id]<<endl;
				if (E >= E_max[hit_id]){
					E_max[hit_id]=E;
					...
					hit_mpid_max[hit_id] = flux_mpid->at(j);
					...
					hit_mvz_max[hit_id]=flux_mvz->at(j)*0.1;
					hit_mvy_max[hit_id]=flux_mvy->at(j)*0.1;
					hit_mvx_max[hit_id]=flux_mvx->at(j)*0.1;
					if(flux_pid->at(j)==22){
			...
			//	cout<<"after loop event="<<i<<" "<<"flux_j="<<j<<" "<<"hit_id="<<hit_id<<" "<<"E="<<E<<" "<<"E_max="<<E_max[hit_id]<<endl;
				if(hit_id==0 ){
					SC_A_p_max=hit_pf;
		...
		// process gem
	        //cout<<"before virtual event="<<i<<" "<<"hit_id="<<hit_id<<"  E_max="<<E_max[hit_id]<<"virtual1_n="<<virtual1_n<<" virtual2_n="<<virtual2_n<<" virtual3_n="<<virtual3_n<<" virtual4_n="<<virtual4_n<<endl;
		GEM00_p = GEM00_p_max;
		GEM10_p = GEM10_p_max;
		GEM01_p = GEM01_p_max;
		GEM11_p = GEM11_p_max;
		...
		int pid_gem00=0;
		int pid_gem10=0;
		double GEM00_ly_gem=0.;
		double GEM00_lx_gem=0.;
		double GEM00_lz_gem=0.;
		/*double GEM00_vx_gem=0.;
		double GEM00_vy_gem=0.;
		double GEM00_vz_gem=0.;
		double GEM10_vx_gem=0.;
		double GEM10_vy_gem=0.;
		double GEM10_vz_gem=0.;*/
		process_tree_solid_gem(tree_solid_gem,totEdep_gem1_gas,totEdep_gem2_gas,totEdep_gem3_gas,totEdep_gem4_gas,totEdep_gem1tot,totEdep_gem2tot,totEdep_gem3tot,totEdep_gem4tot, procID_gem,mpid_gem00,pid_gem00,pid_gem10, GEM00_vx_gem, GEM00_vy_gem, GEM10_vx_gem, GEM10_vy_gem,GEM00_vz_gem,GEM10_vz_gem,GEM00_pz_gem, GEM00_px_gem, GEM00_py_gem, GEM01_pz_gem, GEM00_mvz_gem, GEM00_mvx_gem, GEM00_mvy_gem, GEM00_lz_gem, GEM00_lx_gem, GEM00_ly_gem);
	        //cout<<"event="<<i<<" "<<"gem00_vz="<<GEM00_vz_gem<<endl;
		...
		GEM00_vymax = GEM00_vy_gem;
		GEM00_vxmax = GEM00_vx_gem;
		GEM00_vzmax_gem = GEM00_vz_gem;
		GEM10_vymax = GEM10_vy_gem;
		GEM10_vxmax = GEM10_vx_gem;
		GEM10_vzmax_gem = GEM10_vz_gem;
		GEM00_lymax_gem = GEM00_ly_gem;
		GEM00_lxmax_gem = GEM00_lx_gem;
		GEM00_lzmax_gem = GEM00_lz_gem;
		pid_GEM00 = pid_gem00;
		pid_GEM10 = pid_gem10;
		GEM00_pzmax = GEM00_pz_gem;
		GEM00_pxmax = GEM00_px_gem;
		GEM00_pymax = GEM00_py_gem;
		GEM01_pzmax = GEM01_pz_gem;
		GEM00_mvxmax = GEM00_mvx_gem;
		GEM00_mvymax = GEM00_mvy_gem;
		GEM00_mvzmax = GEM00_mvz_gem;
		GEM00_mpidmax = mpid_gem00;
		//if(GEM00_n>0){
		...
		//if(virtual1_n>0){
			...
			virtual1_mpidmax = hit_mpid_max[12];
		...
		//if(virtual3_n>0){
			...
			virtual3_mpidmax = hit_mpid_max[14];
		...
		//}
			virtual5_Ekmax =  hit_Ek_max[16];
			virtual5_pmax =  hit_p_max[16];
			virtual5_pxmax =  hit_px_max[16];
			virtual5_pymax =  hit_py_max[16];
			virtual5_pzmax =  hit_pz_max[16];
			virtual5_thetamax = hit_th_max[16];
			virtual5_vzmax = hit_vzmax[16];
			virtual5_vymax = hit_vymax[16];
			virtual5_vxmax = hit_vxmax[16];
			virtual5_mvzmax = hit_mvz_max[16];
			virtual5_mvymax = hit_mvy_max[16];
			virtual5_mvxmax = hit_mvx_max[16];
			virtual5_lzmax = hit_lzmax[16];
			virtual5_lymax = hit_lymax[16];
			virtual5_lxmax = hit_lxmax[16];
			virtual5_pidmax = hit_pid_max[16];
			virtual5_tidmax = hit_tid_max[16];
			virtual5_mtidmax = hit_mtid_max[16];
			virtual5_azmax = hit_azmax[16];
			virtual5_aymax = hit_aymax[16];
			virtual5_axmax = hit_axmax[16];

			virtual6_Ekmax =  hit_Ek_max[17];
			virtual6_pmax =  hit_p_max[17];
			virtual6_pxmax =  hit_px_max[17];
			virtual6_pymax =  hit_py_max[17];
			virtual6_pzmax =  hit_pz_max[17];
			virtual6_thetamax = hit_th_max[17];
			virtual6_vzmax = hit_vzmax[17];
			virtual6_vymax = hit_vymax[17];
			virtual6_vxmax = hit_vxmax[17];
			virtual6_mvzmax = hit_mvz_max[17];
			virtual6_mvymax = hit_mvy_max[17];
			virtual6_mvxmax = hit_mvx_max[17];
			virtual6_lzmax = hit_lzmax[17];
			virtual6_lymax = hit_lymax[17];
			virtual6_lxmax = hit_lxmax[17];
			virtual6_pidmax = hit_pid_max[17];
			virtual6_tidmax = hit_tid_max[17];
			virtual6_mtidmax = hit_mtid_max[17];
			virtual6_azmax = hit_azmax[17];
			virtual6_aymax = hit_aymax[17];
			virtual6_axmax = hit_axmax[17];

			virtual7_Ekmax =  hit_Ek_max[18];
			virtual7_pmax =  hit_p_max[18];
			virtual7_pxmax =  hit_px_max[18];
			virtual7_pymax =  hit_py_max[18];
			virtual7_pzmax =  hit_pz_max[18];
			virtual7_thetamax = hit_th_max[18];
			virtual7_vzmax = hit_vzmax[18];
			virtual7_vymax = hit_vymax[18];
			virtual7_vxmax = hit_vxmax[18];
			virtual7_mvzmax = hit_mvz_max[18];
			virtual7_mvymax = hit_mvy_max[18];
			virtual7_mvxmax = hit_mvx_max[18];
			virtual7_lzmax = hit_lzmax[18];
			virtual7_lymax = hit_lymax[18];
			virtual7_lxmax = hit_lxmax[18];
			virtual7_pidmax = hit_pid_max[18];
			virtual7_tidmax = hit_tid_max[18];
			virtual7_mtidmax = hit_mtid_max[18];
			virtual7_mpidmax = hit_mpid_max[18];
			virtual7_azmax = hit_azmax[18];
			virtual7_aymax = hit_aymax[18];
			virtual7_axmax = hit_axmax[18];

			virtual8_Ekmax =  hit_Ek_max[19];
			virtual8_pmax =  hit_p_max[19];
			virtual8_pxmax =  hit_px_max[19];
			virtual8_pymax =  hit_py_max[19];
			virtual8_pzmax =  hit_pz_max[19];
			virtual8_thetamax = hit_th_max[19];
			virtual8_vzmax = hit_vzmax[19];
			virtual8_vymax = hit_vymax[19];
			virtual8_vxmax = hit_vxmax[19];
			virtual8_mvzmax = hit_mvz_max[19];
			virtual8_mvymax = hit_mvy_max[19];
			virtual8_mvxmax = hit_mvx_max[19];
			virtual8_lzmax = hit_lzmax[19];
			virtual8_lymax = hit_lymax[19];
			virtual8_lxmax = hit_lxmax[19];
			virtual8_pidmax = hit_pid_max[19];
			virtual8_tidmax = hit_tid_max[19];
			virtual8_mtidmax = hit_mtid_max[19];
			virtual8_mpidmax = hit_mpid_max[19];
			virtual8_azmax = hit_azmax[19];
			virtual8_aymax = hit_aymax[19];
			virtual8_axmax = hit_axmax[19];

			virtual9_Ekmax =  hit_Ek_max[20];
			virtual9_pmax =  hit_p_max[20];
			virtual9_pxmax =  hit_px_max[20];
			virtual9_pymax =  hit_py_max[20];
			virtual9_pzmax =  hit_pz_max[20];
			virtual9_thetamax = hit_th_max[20];
			virtual9_vzmax = hit_vzmax[20];
			virtual9_vymax = hit_vymax[20];
			virtual9_vxmax = hit_vxmax[20];
			virtual9_mvzmax = hit_mvz_max[20];
			virtual9_mvymax = hit_mvy_max[20];
			virtual9_mvxmax = hit_mvx_max[20];
			virtual9_lzmax = hit_lzmax[20];
			virtual9_lymax = hit_lymax[20];
			virtual9_lxmax = hit_lxmax[20];
			virtual9_pidmax = hit_pid_max[20];
			virtual9_tidmax = hit_tid_max[20];
			virtual9_mtidmax = hit_mtid_max[20];
			virtual9_mpidmax = hit_mpid_max[20];
			virtual9_azmax = hit_azmax[20];
			virtual9_aymax = hit_aymax[20];
			virtual9_axmax = hit_axmax[20];

			virtual10_Ekmax =  hit_Ek_max[21];
			virtual10_pmax =  hit_p_max[21];
			virtual10_pxmax =  hit_px_max[21];
			virtual10_pymax =  hit_py_max[21];
			virtual10_pzmax =  hit_pz_max[21];
			virtual10_thetamax = hit_th_max[21];
			virtual10_vzmax = hit_vzmax[21];
			virtual10_vymax = hit_vymax[21];
			virtual10_vxmax = hit_vxmax[21];
			virtual10_mvzmax = hit_mvz_max[21];
			virtual10_mvymax = hit_mvy_max[21];
			virtual10_mvxmax = hit_mvx_max[21];
			virtual10_lzmax = hit_lzmax[21];
			virtual10_lymax = hit_lymax[21];
			virtual10_lxmax = hit_lxmax[21];
			virtual10_pidmax = hit_pid_max[21];
			virtual10_tidmax = hit_tid_max[21];
			virtual10_mtidmax = hit_mtid_max[21];
			virtual10_mpidmax = hit_mpid_max[21];
			virtual10_azmax = hit_azmax[21];
			virtual10_aymax = hit_aymax[21];
			virtual10_axmax = hit_axmax[21];

			virtual11_Ekmax =  hit_Ek_max[22];
			virtual11_pmax =  hit_p_max[22];
			virtual11_pxmax =  hit_px_max[22];
			virtual11_pymax =  hit_py_max[22];
			virtual11_pzmax =  hit_pz_max[22];
			virtual11_thetamax = hit_th_max[22];
			virtual11_vzmax = hit_vzmax[22];
			virtual11_vymax = hit_vymax[22];
			virtual11_vxmax = hit_vxmax[22];
			virtual11_mvzmax = hit_mvz_max[22];
			virtual11_mvymax = hit_mvy_max[22];
			virtual11_mvxmax = hit_mvx_max[22];
			virtual11_lzmax = hit_lzmax[22];
			virtual11_lymax = hit_lymax[22];
			virtual11_lxmax = hit_lxmax[22];
			virtual11_pidmax = hit_pid_max[22];
			virtual11_tidmax = hit_tid_max[22];
			virtual11_mtidmax = hit_mtid_max[22];
			virtual11_mpidmax = hit_mpid_max[22];
			virtual11_azmax = hit_azmax[22];
			virtual11_aymax = hit_aymax[22];
			virtual11_axmax = hit_axmax[22];
			// process ec
		...
		npe_hgc_total_trigged=0;		  
	        //cout<<"event="<<i<<" "<<"gem00_vz="<<GEM00_vz_gem<<"gem00_vz_tree="<<GEM00_vzmax_gem<<endl;
		outTree->Fill();
		Is_prime=0;
	} //end loop
	cout<<endl;
